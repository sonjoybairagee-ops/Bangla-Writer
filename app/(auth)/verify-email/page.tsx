    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-white to-pink-50 p-4">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl border border-slate-100 p-8 text-center">
        ...
        <p className="text-slate-500 text-sm mb-6">
          Email verification is currently disabled. You can directly login after registration.
        </p>
        <Link 
          href="/login"
          className="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-700 hover:to-pink-600 text-white font-bold rounded-xl transition-all"
        >
          Go to Login
        </Link>
      </div>
...
/* OTP VERIFICATION CODE - DISABLED BUT KEPT FOR FUTURE USE
