...
OUTPUT LANGUAGE: ${params.language === 'banglish' ? 'Conversational Banglish (Bengali words written using English alphabet)' : params.language === 'english' ? 'English' : 'Bangla (শুদ্ধ বাংলা)'}. All generated text (titles, descriptions, text overlay, etc.) MUST be written strictly in this language.
...
OUTPUT LANGUAGE: ${params.language === 'banglish' ? 'Conversational Banglish (Bengali words written using English alphabet)' : params.language === 'english' ? 'English' : 'Bangla (শুদ্ধ বাংলা)'}. All generated text (headlines, descriptions, copy, etc.) MUST be written strictly in this language.
...
OUTPUT LANGUAGE: ${params.language === 'banglish' ? 'Conversational Banglish (Bengali words written using English alphabet)' : params.language === 'english' ? 'English' : 'Bangla (শুদ্ধ বাংলা)'}. All generated text (scripts, hooks, talking points, etc.) MUST be written strictly in this language.
...
OUTPUT LANGUAGE: ${params.language === 'banglish' ? 'Conversational Banglish (Bengali words written using English alphabet)' : params.language === 'english' ? 'English' : 'Bangla (শুদ্ধ বাংলা)'}. All generated text (descriptions, names, text overlay, etc.) MUST be written strictly in this language.
...
OUTPUT LANGUAGE: ${params.language === 'banglish' ? 'Conversational Banglish (Bengali words written using English alphabet)' : params.language === 'english' ? 'English' : 'Bangla (শুদ্ধ বাংলা)'}. All descriptive text fields ("description", "visualStyle", "moodKeywords", "designPrinciples") MUST be written strictly in this language. Font names, hex codes, and brand/reference names stay as-is (proper nouns are not translated).
